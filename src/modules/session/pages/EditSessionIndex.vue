<template>
  <q-page padding>
    <div class="brand_sb text-center text-h3 q-my-lg">Edit Session</div>
...
onMounted(async () => {
  ...
  sessionLength.value = data.value.sessionLength || ''
  sessionDescription.value = data.value.sessionDescription || ''
  playgroundLink.value = data.value.playgroundLink || ''
  sessionDate.value = data.value.sessionDate || ''
  discussionOption.value =
    data.value.discussionOption !== undefined ? Boolean(data.value.discussionOption) : true

  materialLinks.value = Array.isArray(data.value.materialLinks) ? data.value.materialLinks : []
  codingPlatformLinks.value = Array.isArray(data.value.codingPlatformLinks)
    ? data.value.codingPlatformLinks
    : []
  videoLink.value = Array.isArray(data.value.videoLink) ? data.value.videoLink : []
